#
#  Copyright (c) 2014 Adatronics.com & Shang Ma(shangma.1st@gmail.com)  All right reserved.
...
CHIP_NAME=sam3x8h
CHIP_SERIE=sam3xa
else ifeq ($(CHIP), STM32L1XX_HD)
CHIP_NAME=stm32l1xx_hd
CHIP_SERIE=STM32L1xx
else ifeq ($(CHIP), STM32L1XX_MDP)
CHIP_NAME=stm32l1xx_mdp
CHIP_SERIE=STM32L1xx
endif
